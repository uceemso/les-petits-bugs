---
title: "J’ai demandé à mon fils de me montrer la taille de sa colère"
seoTitle: "Aider un enfant à exprimer une grosse colère"
description: "Quand les mots ne suffisent pas, montrer la taille de sa colère avec ce qui nous entoure peut aider un enfant à traverser une grosse émotion."
...
<div class="callout">« Tu es vraiment contrarié. Je comprends. Moi aussi, je serais contrariée. »</div>

Mais parfois, reconnaître une émotion ne suffit pas à la faire redescendre.

Et la sienne continuait de grandir.

<div class="callout">« Grande comment ? »</div>

J’ai ramassé un minuscule morceau de bois qui se trouvait par terre.

Je lui ai demandé :

<div class="callout">« Ton émotion est grande comme ça ? »</div>

<div class="callout">« Plus grande. »</div>

J’en ai ramassé un autre, un peu plus gros.

<div class="callout">« Comme ça ? »</div>

<div class="callout">« Encore plus grande. »</div>

À ce moment-là, il ne pleurait déjà presque plus.

Alors j’ai trouvé un énorme bâton.

<div class="callout">« Aussi grande que ça ? »</div>

Cette fois, Gabriel a souri.

<div class="callout">« Oui ! »</div>
...
<div class="callout">« Je peux monter dessus ? »</div>
